...
public abstract class Hole extends Movable {
...
//    public float yEnd;
    ...
    public Hole(int resourceId, float posX, float posY, Context context) {
        super(posX, posY);
        ...
        pivotx = drawable.getIntrinsicWidth()/6;
        pivoty = drawable.getIntrinsicHeight()/6;

...
public class PlantPunchFragment extends Fragment {
    ImageButton punch1, punch2, punch3, punch4, punch5, punch6, punch7, punch8, punch9, punch10, punch11, punch12, punch13, punch14, punch15, punch16, punch17, punch18, punch19, punch20, punch21, punch22, punch23, punch24;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.plant_frag_punch, container, false);
        init(rootView);
    ...
    public void init(View view){
        ...
        ImageButton[]buttons = {punch1, punch2, punch3, punch4, punch5, punch6, punch7, punch8, punch9, punch10, punch11, punch12, punch13, punch14, punch15, punch16, punch17, punch18, punch19, punch20, punch21, punch22, punch23, punch24};

        for(ImageButton button: buttons){
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    callback.onAddButtonClicked(v, MovableType.P_SHAPE);
